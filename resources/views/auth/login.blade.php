...
{{--<form  method="POST" action="{{ route('login') }}" id="form_login">--}}
    ...
    {{--<h4 style="font-family: Battambang">Login Tool</h4>--}}
    ...
    {{--<div class="form-group">--}}
        ...
        {{--<a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('password.request') }}" style="font-size: 12px;text-decoration: none">--}}
...
<x-guest-layout>
    <x-jet-authentication-card>
        ...
        @endif
        <form method="POST" action="{{ route('login') }}" id="form_login">
            <h5 style="text-align: center;font-family: Battambang">ចូលគណនី</h5>
            @csrf
            <div>
            ...
            <div class="flex items-center justify-end mt-4" style="font-family: Battambang;" >
                @if (Route::has('password.request'))
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('password.request') }}" style="text-decoration: none">
                        {{--{{ __('Forgot your password?') }}--}}
                        ភ្លេចលេខសំងាត់
                    </a>
                @endif
        ...
        <a class="underline text-sm text-gray-600 hover:text-gray-900" href="/register" style="text-decoration: none;font-family: Battambang">
            {{--{{ __('Register Account') }}--}}
            បង្កើតគណនី
        </a>
    </x-jet-authentication-card>
